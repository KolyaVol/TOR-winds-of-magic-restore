...
{
    public sealed partial class WindsOfMagicRestoreSettings : AttributeGlobalSettings<WindsOfMagicRestoreSettings>
    {
        ...
        public string CompanionKillRewardOptionsGroup => EnableCompanionKillRewards ? "Settings" : string.Empty;
